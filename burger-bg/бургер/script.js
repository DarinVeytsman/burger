...
var vClose = document.querySelector('.view__close');
var bg = document.querySelector('.view>img');
var hover = document.querySelector('.receipt .receipt__window');

for (let i = 0; i < info.length; i++) {
  info[i].addEventListener('dblclick', function () {
    bg.setAttribute('src', `images/product${i + 1}.jpg`);
